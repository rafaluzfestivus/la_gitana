...
export function HighlightCard() {
    return (
        <div className="relative flex flex-col justify-center items-center h-full w-full bg-lead-800/40 border border-white/10 p-8 text-center overflow-hidden group">
            {/* Background Decor */}
            <div className="absolute inset-0 bg-gradient-to-br from-gold-500/5 to-transparent opacity-50" />

            <div className="relative z-10 space-y-4">
                <h3 className="font-serif text-2xl md:text-3xl text-cream-100 leading-tight">
